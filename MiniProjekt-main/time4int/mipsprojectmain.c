...
/*
Hela main är samma som från labb 3 förutom: 
Tagit bort text och ikon som visades.
*/
int main(void) {
        /*
	...
	*/
	...
	display_update();
	projectinit(); /* Do any project-specific initialization */
	...
	while( 1 )
	{
	  projectwork(); /* Do project-specific things again and again */
	}
	return 0;
}